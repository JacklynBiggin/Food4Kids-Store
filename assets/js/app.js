    ...
    if (cartPrice == 0) {
        ...
        var handler = StripeCheckout.configure({
            ...
            token: function(token, args) {
                $.post('https://ddf47c07.ngrok.io/Food4Kids-Store/api/?action=create_charge', {"token": token.id, "email": token.email, "amount": cartPrice, "arguments": args}, function (data) {
                    console.log("Called")
                    console.log(data)
                ...
                window.location = "https://ddf47c07.ngrok.io/Food4Kids-Store/?page=complete&total=" + cartPrice
